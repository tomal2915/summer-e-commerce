...
document.getElementById('first-card').addEventListener('click', handleCardClick);

document.getElementById('second-card').addEventListener('click', handleCardClick);

document.getElementById('third-card').addEventListener('click', handleCardClick);

document.getElementById('fourth-card').addEventListener('click', handleCardClick);

document.getElementById('fifth-card').addEventListener('click', handleCardClick);

document.getElementById('sixth-card').addEventListener('click', handleCardClick);
